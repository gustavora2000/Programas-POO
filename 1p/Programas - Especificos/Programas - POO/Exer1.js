...
//si el elemnto es neutro multiplicativo.
  print("Verificar si el numero es neutro multiplicativo");
if(num != 1){
    print("'" + num + "' no es nuetro multiplcativo");
}

if(num1 != 1){
    print("'" + num1 + "' no es nuetro multiplcativo");
}

if(num2 != 1){
    print("'" + num2 + "' no es nuetro multiplcativo");
}
...
if(num * num > 0){
    print("El cuadrado de: '" + num + "' es positivo");
}

if(num1 * num1 > 0){
    print("El cuadrado de: '" + num1 + "' es positivo");
}

if(num2 * num2 > 0){
    print("El cuadrado de: '" + num2 + "' es positivo");
}
